...
data <- fread("E:/Desktop(Current)/DACA/Data/New Data/Newest Data/Grouped Data (Past Settlement_Manual)/Over-All.csv")
...
data_states <- fread("E:/Desktop(Current)/DACA/Data/New Data/Newest Data/Grouped Data (Past Settlement_Manual)/All3 (from 2012).csv")
...
data_states$weight <- sum(data_states$n_ijt)/(data_states$n_ijt)
...
data_tx <- fread("E:/Desktop(Current)/DACA/Data/New Data/Newest Data/Grouped Data (Past Settlement_Manual)/Texas.csv")
...
data_tx$weight <- sum(data_tx$n_ijt)/(data_tx$n_ijt)
...
data_fl <- fread("E:/Desktop(Current)/DACA/Data/New Data/Newest Data/Grouped Data (Past Settlement_Manual)/florida.csv")
...
data_fl$weight <- sum(data_fl$n_ijt)/(data_fl$n_ijt)
...
data_cali <- fread("E:/Desktop(Current)/DACA/Data/New Data/Newest Data/Grouped Data (Past Settlement_Manual)/Original grouped data 2 cali.csv")
...
data_cali$weight <- sum(data_cali$n_ijt)/(data_cali$n_ijt)
...
reg4_cali <- lm(wkwork ~ logshock + factor(exptotal)+ factor(YEAR) + factor(schl) +Ind_01 + Ind_02 + Ind_03 + Ind_04 + Ind_05 + Ind_06 +
                Ind_07 + Ind_08 + Ind_09 + Ind_10 + Ind_11 + Ind_12 + Ind_13 + Ind_14 + Ind_15 , data=data_cali)

reg4_cali_w <- lm(wkwork ~ logshock + factor(exptotal)+ factor(YEAR) + factor(schl) +Ind_01 + Ind_02 + Ind_03 + Ind_04 + Ind_05 + Ind_06 +
                  Ind_07 + Ind_08 + Ind_09 + Ind_10 + Ind_11 + Ind_12 + Ind_13 + Ind_14 + Ind_15 , weights=weight, data=data_cali)
...
summary(data_cali)
data_cali$IV <- ifelse(data_cali$IV == 0, 0.12987, data_cali$IV)
...
ivmodel_4 <- ivreg(wkwork ~ logshock + factor(exptotal)+ factor(YEAR) + factor(schl) +Ind_01 + Ind_02 + Ind_03 + Ind_04 + Ind_05 + Ind_06 +
                     Ind_07 + Ind_08 + Ind_09 + Ind_10 + Ind_11 + Ind_12 + Ind_13 + Ind_14 + Ind_15|logIV+ factor(exptotal)+ factor(YEAR) + factor(schl) +Ind_01 + Ind_02 + Ind_03 + Ind_04 + Ind_05 + Ind_06 +
                     Ind_07 + Ind_08 + Ind_09 + Ind_10 + Ind_11 + Ind_12 + Ind_13 + Ind_14 + Ind_15 , data=data_cali)

ivmodel_4_w <- ivreg(wkwork ~ logshock + factor(exptotal)+ factor(YEAR) + factor(schl) +Ind_01 + Ind_02 + Ind_03 + Ind_04 + Ind_05 + Ind_06 +
                     Ind_07 + Ind_08 + Ind_09 + Ind_10 + Ind_11 + Ind_12 + Ind_13 + Ind_14 + Ind_15|logIV+ factor(exptotal)+ factor(YEAR) + factor(schl) +Ind_01 + Ind_02 + Ind_03 + Ind_04 + Ind_05 + Ind_06 +
                     Ind_07 + Ind_08 + Ind_09 + Ind_10 + Ind_11 + Ind_12 + Ind_13 + Ind_14 + Ind_15 , weights=weight, data=data_cali)
